...
/*         if (inputArray[2][3]) {
        Costs = Costs + 25; // 5. Dan Kodansha Training
        description = "<br><br>-Single trainings Cost exceeds flat rate for whole seminar <br> Cost for whole seminar is: " + Costs + ",00 € <br> +25,00 € for 5. Dan Kodansha training";    
        } */
...
// -> THIS YEAR NOT NECESSARY
    if (inputArray[2][3] && flatRateSeminar) { // 5. Dan Kodansha Training
        Costs += 25; 
...
function calculateMaxCosts() {
    ...
    if (!inputArray[2][3] && !inputArray[3][1]) { maxSeminarCosts = 290; } // all but 4. Dan
    if (!inputArray[2][3] && !inputArray[3][1] && !inputArray[1][3] && !inputArray[4][0]) { maxSeminarCosts = 260; } // all but 3. Dan
    if (!inputArray[2][3] && !inputArray[3][1] && !inputArray[1][3] && !inputArray[4][0] && !inputArray[1][2]) { maxSeminarCosts = 245; } // all but 2. Dan
    ...
    if (!inputArray[2][3] && !inputArray[3][1] && !inputArray[1][3] && !inputArray[4][0] && !inputArray[1][2] && !inputArray[0][3] && !inputArray[3][3] && !inputArray[0][1] && !inputArray[2][2] && !inputArray[3][2] && !inputArray[1][1] && !inputArray[2][1] && !inputArray[0][2]) { maxSeminarCosts = 120; } // all but 4.Kyu
